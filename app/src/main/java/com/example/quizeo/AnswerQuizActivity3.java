...
public class AnswerQuizActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.fragment_answer_quiz_3);
    }
    @Override
    protected void onStart() {
        ...
        buttonAnswer1 = (Button) findViewById(R.id.answer_3_1);
        buttonAnswer2 = (Button) findViewById(R.id.answer_3_2);
        buttonAnswer3 = (Button) findViewById(R.id.answer_3_3);

        next = (Button) findViewById(R.id.next_question_3);

        quit = (Button) findViewById(R.id.quit_3);

        if (!quiz.nextQuestionExists()) {
            next.setText("End quiz!");
        }

        currentQuestionNumber = (TextView) findViewById(R.id.current_question_3);
        numberCorrect = (TextView) findViewById(R.id.score_3);
        currentQuestionText = (TextView) findViewById(R.id.question_3);
